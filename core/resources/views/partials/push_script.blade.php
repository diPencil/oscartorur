        ...
        if(!('Notification' in window)){
            ...
            $('.notice').append(`
                <div class="row notification-alert">
                    <div class="col-lg-12">
                        <div class="card trip-card my-4">
                            <div class="card-header bg-white justify-content-between d-flex flex-wrap notice_notify">
                                <h5>@lang('Please Allow / Reset Browser Notification') <i class='las la-bell text--danger'></i></h5>
                            </div>
                            <div class="card-body">
