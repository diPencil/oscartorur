                                            ...
                                            <div class="tab-content mt-3">
                                                ...
                                                <div class="tab-pane fade" id="lang-ar-{{ $k }}" role="tabpanel" dir="rtl">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="10" class="form-control" name="{{ $k }}_ar" dir="rtl">{{ old($k.'_ar', @$data->data_values->{$k.'_ar'}) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="tab-content mt-3">
                                                ...
                                                <div class="tab-pane fade" id="lang-ar-{{ $k }}" role="tabpanel" dir="rtl">
                                                    <div class="form-group">
                                                        <label class="d-block text-end">{{ __(keyToTitle($k)) }} (Arabic)</label>
                                                        <textarea rows="10" class="form-control nicEdit" name="{{ $k }}_ar" dir="rtl">{{ old($k.'_ar', @$data->data_values->{$k.'_ar'}) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="tab-content mt-3">
                                                ...
                                                <div class="tab-pane fade" id="lang-ar-{{ $k }}" role="tabpanel" dir="rtl">
                                                    <div class="form-group">
                                                        <label class="d-block text-end">{{ __(keyToTitle($k)) }} (Arabic)</label>
                                                        <input type="text" class="form-control" name="{{ $k }}_ar" value="{{ old($k.'_ar', @$data->data_values->{$k.'_ar'}) }}" dir="rtl">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
