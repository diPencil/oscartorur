                                                ...
                                                <div class="col-md-12">
                                                    <ul class="nav nav-tabs nav-tabs--style1" role="tablist">
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#lang-en-{{ $k }}" type="button" role="tab">
                                                                <i class="las la-language"></i> @lang('English (Default)')
                                                            </button>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#lang-ar-{{ $k }}" type="button" role="tab" dir="rtl">
                                                                <i class="las la-language"></i> @lang('Arabic (عربي)')
                                                            </button>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content mt-3">
                                                        <div class="tab-pane fade show active" id="lang-en-{{ $k }}" role="tabpanel">
                                                            <div class="form-group">
                                                                <label>{{ __(keyToTitle($k)) }}</label>
                                                                <textarea rows="10" class="form-control" name="{{ $k }}" required>{{ @$content->data_values->$k }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane fade" id="lang-ar-{{ $k }}" role="tabpanel" dir="rtl">
                                                            <div class="form-group">
                                                                <label class="d-block text-end">{{ __(keyToTitle($k)) }} (Arabic)</label>
                                                                <textarea rows="10" class="form-control" name="{{ $k }}_ar" dir="rtl">{{ @$content->data_values->{$k.'_ar'} }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="tab-content mt-3">
                                                        ...
                                                        <div class="tab-pane fade" id="lang-ar-{{ $k }}" role="tabpanel" dir="rtl">
                                                            <div class="form-group">
                                                                <label class="d-block text-end">{{ __(keyToTitle($k)) }} (Arabic)</label>
                                                                <textarea rows="10" class="form-control nicEdit" name="{{ $k }}_ar" dir="rtl">{{ @$content->data_values->{$k.'_ar'} }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="tab-content mt-3">
                                                        ...
                                                        <div class="tab-pane fade" id="lang-ar-{{ $k }}" role="tabpanel" dir="rtl">
                                                            <div class="form-group">
                                                                <label class="d-block text-end">{{ __(keyToTitle($k)) }} (Arabic)</label>
                                                                <input type="text" class="form-control" name="{{ $k }}_ar" value="{{ @$content->data_values->{$k.'_ar'} }}" dir="rtl">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            @foreach ($section->element as $k => $type)
                                @if ($k != 'modal')
                                    ...
                                    @elseif($type == 'textarea')
                                        <ul class="nav nav-tabs nav-tabs--style1" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#lang-en-add-{{ $k }}" type="button" role="tab">
                                                    <i class="las la-language"></i> @lang('English (Default)')
                                                </button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#lang-ar-add-{{ $k }}" type="button" role="tab" dir="rtl">
                                                    <i class="las la-language"></i> @lang('Arabic (عربي)')
                                                </button>
                                            </li>
                                        </ul>
                                        <div class="tab-content mt-3">
                                            <div class="tab-pane fade show active" id="lang-en-add-{{ $k }}" role="tabpanel">
                                                <div class="form-group">
                                                    <label>{{ __(keyToTitle($k)) }}</label>
                                                    <textarea rows="4" class="form-control" name="{{ $k }}" required></textarea>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="lang-ar-add-{{ $k }}" role="tabpanel" dir="rtl">
                                                <div class="form-group">
                                                    <label class="d-block text-end">{{ __(keyToTitle($k)) }} (Arabic)</label>
                                                    <textarea rows="4" class="form-control" name="{{ $k }}_ar" dir="rtl"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @elseif($type == 'textarea-nic')
                                        ...
                                        <div class="tab-content mt-3">
                                            ...
                                            <div class="tab-pane fade" id="lang-ar-add-{{ $k }}" role="tabpanel" dir="rtl">
                                                <div class="form-group">
                                                    <label class="d-block text-end">{{ __(keyToTitle($k)) }} (Arabic)</label>
                                                    <textarea rows="4" class="form-control nicEdit" name="{{ $k }}_ar" dir="rtl"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @else
                                        ...
                                        <div class="tab-content mt-3">
                                            ...
                                            <div class="tab-pane fade" id="lang-ar-add-{{ $k }}" role="tabpanel" dir="rtl">
                                                <div class="form-group">
                                                    <label class="d-block text-end">{{ __(keyToTitle($k)) }} (Arabic)</label>
                                                    <input type="text" class="form-control" name="{{ $k }}_ar" dir="rtl">
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                            ...
                            @foreach ($section->element as $k => $type)
                                @if ($k != 'modal')
                                    ...
                                    @elseif($type == 'textarea')
                                        <ul class="nav nav-tabs nav-tabs--style1" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#lang-en-update-{{ $k }}" type="button" role="tab">
                                                    <i class="las la-language"></i> @lang('English (Default)')
                                                </button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#lang-ar-update-{{ $k }}" type="button" role="tab" dir="rtl">
                                                    <i class="las la-language"></i> @lang('Arabic (عربي)')
                                                </button>
                                            </li>
                                        </ul>
                                        <div class="tab-content mt-3">
                                            <div class="tab-pane fade show active" id="lang-en-update-{{ $k }}" role="tabpanel">
                                                <div class="form-group">
                                                    <label>{{ keyToTitle($k) }}</label>
                                                    <textarea rows="4" class="form-control" name="{{ $k }}" required></textarea>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="lang-ar-update-{{ $k }}" role="tabpanel" dir="rtl">
                                                <div class="form-group">
                                                    <label class="d-block text-end">{{ keyToTitle($k) }} (Arabic)</label>
                                                    <textarea rows="4" class="form-control" name="{{ $k }}_ar" dir="rtl"></textarea>
                                                </div>
                                            </div>
                                        </div>
