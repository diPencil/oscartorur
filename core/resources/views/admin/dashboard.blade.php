...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ $widget['total_hotels'] }}" title="Total Hotels" style="6" link="{{ route('admin.hotel.index') }}" icon="las la-hotel" bg="primary" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ $widget['active_hotels'] }}" title="Active Hotels" style="6" link="{{ route('admin.hotel.index') }}" icon="las la-check-circle" bg="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ $widget['total_hotel_bookings'] }}" title="Hotel Bookings" style="6" link="{{ route('admin.hotel.booking.index') }}" icon="las la-clipboard-list" bg="info" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                      value="{{ $widget['pending_hotel_bookings'] }}" title="Pending Bookings" style="6" link="{{ route('admin.hotel.booking.pending') }}" icon="las la-spinner" bg="warning" />
        </div>
    </div>
    ...
    <script>
        ...
        const dateRangeOptions = {
            ...
            ranges: {
                ...
                "@lang('Last 15 Days')": [moment().subtract(14, 'days'), moment()],
                "@lang('Last 30 Days')": [moment().subtract(30, 'days'), moment()],
                ...
                "@lang('Last 6 Months')": [moment().subtract(6, 'months').startOf('month'), moment().endOf('month')],
            ...
            locale: {
                ...
                daysOfWeek: [
                    "@lang('Su')", "@lang('Mo')", "@lang('Tu')", "@lang('We')", "@lang('Th')", "@lang('Fr')", "@lang('Sa')"
                ],
                monthNames: [
        ...
        const changeDatePickerText = (element, startDate, endDate) => {
            $(element).html(startDate.format('YYYY-MM-DD') + ' - ' + endDate.format('YYYY-MM-DD'));
        }
