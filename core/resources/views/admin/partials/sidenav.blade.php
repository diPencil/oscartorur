...
<div class="sidebar bg--dark">
    ...
    <div class="sidebar__inner">
        ...
        <div class="version-info text-center text-uppercase pb-3">
            <span class="text--primary">{{__(systemDetails()['name'])}}</span>
            <span class="text--success">@lang('V'){{systemDetails()['version']}} </span>
            <div class="mt-2 text-white" style="font-size: 11px; text-transform: capitalize;">Powered by <a href="https://dipencil.com/" target="_blank" class="text--base">Pencil Studio</a></div>
        </div>
    </div>
</div>
<!-- sidebar end -->
