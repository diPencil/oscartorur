                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <ul class="nav nav-tabs nav-tabs--style1" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#lang-en-included" type="button" role="tab">
                                                <i class="las la-language"></i> @lang('English')
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#lang-ar-included" type="button" role="tab" dir="rtl">
                                                <i class="las la-language"></i> @lang('Arabic (عربي)')
                                            </button>
                                        </li>
                                    </ul>
                                    <div class="tab-content mt-3">
                                        <div class="tab-pane fade show active" id="lang-en-included" role="tabpanel">
                                            ...
                                            <select class="form-control select2-auto-tokenize included" name="included[]" multiple="multiple" required>
                                                @if (old('included'))
                                        ...
                                        <div class="tab-pane fade" id="lang-ar-included" role="tabpanel" dir="rtl">
                                            <label class="d-block text-end">@lang('Included') (Arabic)</label>
                                            <small class="d-block text-end ms-2 mt-2">@lang('Separate multiple included by') <code>,</code>(@lang('comma')) @lang('or') <code>@lang('enter')</code> @lang('key')</small>
                                            <select class="form-control select2-auto-tokenize included" name="included_ar[]" multiple="multiple" dir="rtl">
                                                @if (old('included_ar'))
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <ul class="nav nav-tabs nav-tabs--style1" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#lang-en-excluded" type="button" role="tab">
                                                <i class="las la-language"></i> @lang('English')
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#lang-ar-excluded" type="button" role="tab" dir="rtl">
                                                <i class="las la-language"></i> @lang('Arabic (عربي)')
                                            </button>
                                        </li>
                                    </ul>
                                    <div class="tab-content mt-3">
                                        <div class="tab-pane fade show active" id="lang-en-excluded" role="tabpanel">
                                            ...
                                            <select class="form-control select2-auto-tokenize excluded" name="excluded[]" multiple="multiple">
                                                @if (old('excluded'))
                                        ...
                                        <div class="tab-pane fade" id="lang-ar-excluded" role="tabpanel" dir="rtl">
                                            <label class="d-block text-end">@lang('Excluded') (Arabic)</label>
                                            <small class="d-block text-end ms-2 mt-2">@lang('Separate multiple excluded by') <code>,</code>(@lang('comma')) @lang('or') <code>@lang('enter')</code> @lang('key')</small>
                                            <select class="form-control select2-auto-tokenize excluded" name="excluded_ar[]" multiple="multiple" dir="rtl">
                                                @if (old('excluded_ar'))
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('Seminar Images')</label>
                                    <div class="input-images"></div>
                                    <div class="mt-1">
                                        <small class="mt-3 text-muted"> @lang('Supported Files:')
                                            <b>@lang('.png, .jpg, .jpeg')</b> @lang('Image will be resized into') <b>{{ getFileSize('seminar') }}</b>@lang('px')
                                        </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <ul class="nav nav-tabs nav-tabs--style1" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#lang-en-seminar-plan" type="button" role="tab">
                                            <i class="las la-language"></i> @lang('English')
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#lang-ar-seminar-plan" type="button" role="tab" dir="rtl">
                                            <i class="las la-language"></i> @lang('Arabic (عربي)')
                                        </button>
                                    </li>
                                </ul>
                                <div class="tab-content mt-3">
                                    <div class="tab-pane fade show active" id="lang-en-seminar-plan" role="tabpanel">
                                        <div class="card">
                                            <h5 class="card-header bg--primary d-flex justify-content-between">@lang('Seminer Plan Specifications')
                                            ...
                                            <div class="card-body">
                                                <div class="row addedSeminerInfo">
                                                    @foreach ($plan->seminar_plan ?? [] as $index => $seminar)
                                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 removeSeminerInfo">
                                                            <div class="card card-body">
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="seminar[{{ $index }}][title]" type="text" value="{{ @$seminar->title }}" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="seminar[{{ $index }}][subtitle]" type="text" value="{{ @$seminar->subtitle }}" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <textarea class="form-control" name="seminar[{{ $index }}][content]" required>{{ @$seminar->content }}</textarea>
                                                                    </div>
                                                                </div>

                                                                <button class="btn removeSeminerRow btn--danger border--danger" type="button"><i class="fas fa-times"></i></button>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-ar-seminar-plan" role="tabpanel" dir="rtl">
                                        <div class="card">
                                            <h5 class="card-header bg--primary d-flex justify-content-between">@lang('Seminer Plan Specifications') (Arabic)
                                                <button class="btn btn-sm btn-outline-light addBtnAr" type="button">
                                                    <i class="las la-plus"></i>@lang('Add New')
                                                </button>
                                            </h5>

                                            <div class="card-body">
                                                <div class="row addedSeminerInfoAr">
                                                    @foreach ($plan->seminar_plan_ar ?? [] as $index => $seminar)
                                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 removeSeminerInfoAr">
                                                            <div class="card card-body">
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="seminar_ar[{{ $index }}][title]" type="text" value="{{ @$seminar->title }}" dir="rtl">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <input class="form-control" name="seminar_ar[{{ $index }}][subtitle]" type="text" value="{{ @$seminar->subtitle }}" dir="rtl">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <textarea class="form-control" name="seminar_ar[{{ $index }}][content]" dir="rtl">{{ @$seminar->content }}</textarea>
                                                                    </div>
                                                                </div>

                                                                <button class="btn removeSeminerRowAr btn--danger border--danger" type="button"><i class="fas fa-times"></i></button>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
...
@push('breadcrumb-plugins')
    <x-back route="{{ route('admin.seminar.index') }}" />
@endpush
    ...
    <script>
        (function($) {
            ...
            $('.addBtn').on('click', function() {
                $(".addedSeminerInfo").append(`
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 removeSeminerInfo">
                    <div class="card card-body">
                        <div class="form-group">
                            <div class="input-group">
                                <input class="form-control" placeholder="@lang('Enter title')" name="seminar[${count}][title]" type="text" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <input class="form-control" placeholder="@lang('Enter subtitle')" name="seminar[${count}][subtitle]" type="text" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                              <textarea class="form-control" placeholder="@lang('Enter content')" name="seminar[${count}][content]" required> </textarea>
                            </div>
                        </div>
            ...
            $(document).on('click', '.removeSeminerRow', function() {
                $(this).closest('.removeSeminerInfo').remove();
            });

            var countAr = 0;
            $('.addBtnAr').on('click', function() {
                $(".addedSeminerInfoAr").append(`
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 removeSeminerInfoAr">
                    <div class="card card-body">
                        <div class="form-group">
                            <div class="input-group">
                                <input class="form-control" placeholder="@lang('Enter title') (Arabic)" name="seminar_ar[${countAr}][title]" type="text" dir="rtl">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <input class="form-control" placeholder="@lang('Enter subtitle') (Arabic)" name="seminar_ar[${countAr}][subtitle]" type="text" dir="rtl">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                              <textarea class="form-control" placeholder="@lang('Enter content') (Arabic)" name="seminar_ar[${countAr}][content]" dir="rtl"> </textarea>
                            </div>
                        </div>
            ...
            $(document).on('click', '.removeSeminerRowAr', function() {
                $(this).closest('.removeSeminerInfoAr').remove();
            });
