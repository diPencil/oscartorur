        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="7"
                        link="{{ route('admin.plan.booking.log') }}?search={{ $user->username }}"
                        title="Total Booked Tours"
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="7"
                        link="{{ route('admin.seminar.booking.log') }}?search={{ $user->username }}"
                        title="Total Booked Seminars"
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget
                        style="7"
                        link="{{ route('admin.hotel.booking.index') }}?search={{ $user->username }}"
                        title="Total Booked Hotels"
                        icon="las la-hotel"
                        value="{{ $bookedHotel }}"
                        bg="success"
                        type="2"
                ...
                <div class="card-body">
                    <form action="{{route('admin.users.update',[$user->id])}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    <label>@lang('B2B Agency')</label>
                                    <select name="agency_id" class="form-control select2">
                                        <option value="">@lang('None (Normal User)')</option>
                                        @foreach($agencies as $agency)
                                            <option value="{{ $agency->id }}" @selected($user->agency_id == $agency->id)>{{ $agency->name }} ({{ $agency->code }})</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
