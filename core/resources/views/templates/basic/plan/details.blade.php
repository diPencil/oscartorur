                ...
                <div class="col-lg-8 pe-lg-5">
                    ...
                    <div class="tab-content mt-5 package-tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
                            ...
                            <a href="{{ getImage(getFilePath('plan') . '/' . @$plan->images[0]) }}" data-rel="lightcase">
                                ...
                                @forelse ($plan->images as $image)
                                    <div class="col-lg-4">
                                        <div class="gallery-card">
                                            ...
                                            <a class="view-thumb" data-rel="lightcase:myCollection:slideshow" href=" {{ getImage(getFilePath('plan') . '/' . @$image) }}"><i class="las la-plus"></i></a>
                                        </div>
                                    </div>
                                @empty
