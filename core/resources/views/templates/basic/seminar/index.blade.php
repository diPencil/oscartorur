            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 bg-white p-3 rounded shadow-sm border">
                        <h5 class="mb-0" style="color: #0b2a5c; font-size: 1rem;"><i class="las la-calendar-day"></i> @lang('Showing') <span class="text-primary-brand fw-bold">{{ $seminars->count() }}</span> @lang('of') {{ $seminars->total() }} @lang('day trips')</h5>
                    ...
                    <div class="row gy-4" id="seminar-results-container">
                        ...
                        @empty
                            <div class="col-12 text-center">
                                @include($activeTemplate . 'partials.empty', ['message' => 'Day trip not found!'])
                            </div>
                        @endforelse
                    </div><!-- row end -->
...
<script>
    (function ($) {
        ...
        $(document).ready(function () {
            // Layout Toggle Logic
            var savedLayout = localStorage.getItem('seminarLayout') || 'grid';
            if (savedLayout === 'list') {
                $('#seminar-results-container').addClass('layout-list');
            ...
            $('.layout-btn').on('click', function() {
                ...
                localStorage.setItem('seminarLayout', layout);
                
                if(layout === 'list') {
                    $('#seminar-results-container').addClass('layout-list');
                } else {
                    $('#seminar-results-container').removeClass('layout-list');
                }
            });
        });
    })(jQuery);
