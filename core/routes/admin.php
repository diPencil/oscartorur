...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function () {
        ...
        Route::get('chart/payments', 'depositAndWithdrawReport')->name('chart.deposit.withdraw');
    ...
    // Amenities
    Route::controller('AmenityController')->name('amenity.')->prefix('amenity')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    Route::controller('HotelController')->name('hotel.')->prefix('hotel')->group(function () {
        ...
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('amenities/{id}', 'syncAmenities')->name('amenities.sync');
        Route::post('status/{id}', 'status')->name('status');
        Route::post('delete/{id}', 'delete')->name('delete');
    });

    // Hotel Images
    Route::controller('HotelImageController')->name('hotel.image.')->prefix('hotel/image')->group(function () {
        Route::post('store-cover/{hotel_id}', 'storeCover')->name('store.cover');
        Route::post('store-gallery/{hotel_id}', 'storeGallery')->name('store.gallery');
        Route::post('delete/{id}', 'delete')->name('delete');
    });

    // Hotel Contracts
    Route::controller('HotelContractController')->name('hotel.contract.')->prefix('hotel/contract')->group(function () {
        Route::get('index/{hotel_id?}', 'index')->name('index');
        Route::get('create/{hotel_id?}', 'create')->name('create');
    ...
    // Bed Types
    Route::controller('BedTypeController')->name('bed.type.')->prefix('bed-type')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    // Contract Room Types
    Route::controller('ContractRoomTypeController')->name('contract.room.type.')->prefix('contract-room-type')->group(function () {
        Route::get('index/{contract_id?}', 'index')->name('index');
        Route::get('create/{contract_id?}', 'create')->name('create');
        Route::get('edit/{id}', 'edit')->name('edit');
        Route::post('store/{id?}', 'store')->name('store');
    });

    // Rate Plans
    Route::controller('RatePlanController')->name('rate.plan.')->prefix('rate-plan')->group(function () {
        Route::get('index/{contract_room_type_id?}', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });

    // Cancellation Policies
    Route::controller('CancellationPolicyController')->name('cancellation.policy.')->prefix('cancellation-policy')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    // Room Inventory
    Route::controller('RoomInventoryController')->name('room.inventory.')->prefix('room-inventory')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store', 'store')->name('store');
    });

    // Room Rates
    Route::controller('RoomRateController')->name('room.rate.')->prefix('room-rate')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store', 'store')->name('store');
    });

    // Markup Rules
    Route::controller('MarkupRuleController')->name('markup.rule.')->prefix('markup-rule')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    // Plans
    Route::controller('ManagePlanController')->name('plan.')->prefix('plan')->group(function () {
        Route::get('index', 'index')->name('index');
        ...
        Route::get('page/seo/{id}', 'frontendSeo')->name('page.seo');
        Route::post('update/seo/{id}', 'frontendSeoUpdate')->name('page.update.seo');
    });

    // Day Trips
    Route::controller('ManageSeminarController')->name('seminar.')->prefix('day-trips')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('add', 'add')->name('add');
        Route::get('edit/{id}', 'edit')->name('edit');
    ...
    // Rating
    Route::controller('RatingController')->name('rating.')->prefix('rating')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('delete/{id}', 'delete')->name('delete');
    });
    ...
    // Hotel Bookings
    Route::controller('HotelBookingController')->name('hotel.booking.')->prefix('hotel-bookings')->group(function(){
        Route::get('/', 'index')->name('index');
    ...
    // B2B Agencies
    Route::controller('AgencyController')->name('agencies.')->prefix('agencies')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('store', 'store')->name('store');
        Route::post('update/{id}', 'update')->name('update');
    });
