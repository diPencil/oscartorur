...
trait UserNotify
{
    public static function notifyToUser(){
        return [
            ...
            'notPlanBookedUsers'    => 'User Has No Tour Booked',
            'hasSeminarBookedUsers' => 'User Has No Seminar Booked',

            'hasBookedPlanUsers'    => 'User Has At least One or Multiple Tour booked Users',
            'hasBookedSeminarUsers' => 'User Has At least One or Multiple Seminar Booked Users',
        ];
    }


    public function scopeNotPlanBookedUsers($query)
    {
        return $query->whereDoesntHave('plans');
    }
    public function scopeHasBookedPlanUsers($query)
    {
        return $query->whereHas('plans');
    }

    public function scopeNotSeminarBookedUsers($query)
    {
        return $query->whereDoesntHave('seminars');
    }
    public function scopeHasBookedSeminarUsers($query)
    {
        return $query->whereHas('seminars');
    }
