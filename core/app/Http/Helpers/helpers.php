...
function getAdvertisement($size) {
    ...
    if ($ad) {
        if ($ad->type == 'image') {
            $advertise = '<div class="__add text-center image-item mt-5 d-none d-md-block click-Up" data-id="' . $ad->id . '">
            <a href="' . $ad->redirect_url . '" target="_blank">
            <img src="' . getImage(getFilePath('advertisement') . '/' . @$ad->content, @$ad->size) . '" alt="Ads">
            </a></div>';
        } else {
            $advertise = '<div class="__add" data-id="' . $ad->id . '">' . $ad->content . '</div>';
        }
        return $advertise;
    } else {
        return $advertise = '<div class="__add text-center">
        <img src="' . getImage(null, $size) . '" alt="Ads"></div>';
    }
